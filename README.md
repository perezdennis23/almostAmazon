...
This application implements a command line based storefront.  It imitates a storefront similar to Amazon to allow a customer to purchase a product in stock.  I utilized nmp inquirer and npm mysql packages to support the storefront functions. The application supports **customer** and **manager** interfaces.
